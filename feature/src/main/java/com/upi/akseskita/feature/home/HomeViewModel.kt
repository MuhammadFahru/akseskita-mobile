...
class HomeViewModel(private val facilityUseCase: FacilityUseCase) : ViewModel() {
    private val _allFacilitiesState: MutableStateFlow<UiState<List<PlaceModel>>> = MutableStateFlow(UiState.Loading)
    val allFacilitiesState: StateFlow<UiState<List<PlaceModel>>> get() = _allFacilitiesState

    private val _topRatedFacilitiesState: MutableStateFlow<UiState<List<PlaceModel>>> = MutableStateFlow(UiState.Loading)
