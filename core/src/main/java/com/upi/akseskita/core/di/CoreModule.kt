package com.upi.akseskita.core.di

import com.upi.akseskita.core.BuildConfig
import com.upi.akseskita.core.data.repository.FacilityRepository
...
val repositoryModule = module {
    ...
    single<IFacilityRepository> { FacilityRepository(get()) }
}